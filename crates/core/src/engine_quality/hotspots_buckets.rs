...
use crate::model::{
    ...
    QualityHotspotStructuralSignals, QualityHotspotsSortBy, QualityRiskScoreBreakdown,
    RuleViolationFileHit,
};
use crate::quality::{StructuralPolicy, StructuralUnmatchedBehavior};
use crate::text_utils::is_low_priority_path;

const UNMATCHED_MODULE_BUCKET: &str = "unmatched";

pub(super) fn aggregate_buckets(
