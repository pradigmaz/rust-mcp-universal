use crate::model::{DivergenceAxis, DivergenceSignal, ImplementationVariant};

use super::common::normalized_values;

pub(super) fn build_divergence_signals(
...
pub(super) struct SignalClassification {
    pub(super) severity: &'static str,
    pub(super) evidence_strength: &'static str,
    pub(super) classification_reason: &'static str,
}

pub(super) fn shared_strong_constraints(variants: &[ImplementationVariant]) -> Vec<String> {
...
pub(super) fn recommended_followups(
    divergence_axes: &[DivergenceAxis],
...
pub(super) fn overall_severity(divergence_signals: &[DivergenceSignal]) -> String {
    divergence_signals
        .iter()
...
pub(super) fn manual_review_required(divergence_signals: &[DivergenceSignal]) -> bool {
