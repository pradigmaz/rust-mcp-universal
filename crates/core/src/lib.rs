...
pub use model::{
    ...
    AxisObservation, BudgetInfo, CallPathEndpoint, CallPathExplain, CallPathResult, CallPathStep,
    ConceptClusterResult, ConceptClusterSummary, ConceptSeed, ConceptSeedKind, ConfidenceInfo,
    ConfidenceSignals, ConstraintEvidence, ConstraintEvidenceResult, ContextFile, ContextMode,
    ContextPackResult, ContextSelection, DbCheckpointResult, DbMaintenanceOptions,
    DbMaintenanceResult, DbMaintenanceStats, DbPruneResult, DeleteIndexResult, DivergenceAxis,
    DivergenceReport, DivergenceSignal, IgnoreInstallReport, IgnoreInstallTarget,
    ...
    InvestigationToolMetrics, InvestigationTopVariant, MigrationMode, PreflightState,
    PreflightStatus, PrivacyMode, QualityDeltaSummary, QualityHotspotAggregation,
    ...
    SymbolBodyItem, SymbolBodyResolutionKind, SymbolBodyResult, SymbolBodyTimings, SymbolMatch,
