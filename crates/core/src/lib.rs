...
pub use model::{
    ...
    PrivacyMode, QualityDeltaSummary, QualityHotspotAggregation, QualityHotspotBucket,
    QualityHotspotRuleCount, QualityHotspotStructuralSignals, QualityHotspotsOptions,
    QualityHotspotsResult, QualityHotspotsSortBy, QualityHotspotsSummary, QualityMode,
    QualitySource, QualityStatus, QueryBenchmarkCase, QueryBenchmarkDataset,
