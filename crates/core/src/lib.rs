...
pub use model::{
    ...
    PrivacyMode, QualityMode, QueryBenchmarkCase, QueryBenchmarkDataset, QueryBenchmarkOptions,
    QueryBenchmarkReport, QueryOptions, QueryQrel, QueryReport, RankExplainBreakdown,
    RelatedFileHit, RetrievalStage, RolloutPhase, RuleViolationFileHit, RuleViolationsOptions,
    RuleViolationsResult, RuleViolationsSortBy, RuleViolationsSummary, ScopePreviewResult,
    SearchHit, SelectedContextItem, SemanticFailMode, SymbolMatch, SymbolReferenceHit,
