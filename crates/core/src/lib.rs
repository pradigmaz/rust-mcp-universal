...
pub use model::{
    ...
    ImplementationVariant, IndexFreshnessStatus, IndexProfile, IndexStatus, IndexTelemetry,
    IndexingOptions, InvestigationAnchor, InvestigationAnchorLabel, InvestigationAssertion,
